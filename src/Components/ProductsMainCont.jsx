import ProductCardCont from "./ProductCardCont";
...
const ProductsMainCont=()=>{
    return(<>
    <h3 style={{textAlign:"center"}}>Products Available </h3>
    <div style={{width:"100vw", margin:"5px", display:"flex", flexWrap:"wrap", justifyContent:"space-evenly", gap:"15px", padding:"10px"}}>
      
      {
        products.map((eachProduct)=>{
          const {id, title, image, brand, model}=eachProduct;
          return(
            <ProductCardCont key={id} title={title} image={image} brand={brand} model={model}/>
          )
        })
      }
    </div>
...
export default ProductsMainCont;